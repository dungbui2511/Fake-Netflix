...
import { BrandWrapper, HeaderIconsWrapper, HeaderWrapper, NavWrapper } from "./Header.style"
...
const Header = () => {
  ...
  return (
    <HeaderWrapper className={`flex items-center ${headerStyle}`}>
      ...
      <li className="nav-item">
      <Link onClick={handleNavLinkClick} to='/subcription' className={`nav-link inline-flex items-center justify-center text-center ${location.pathname === "/subcription" ? "active" : ""}`}>Subcription</Link>
      </li>
      </ul>
      </NavWrapper>
      ...
      <button type="button" className="icon-link flex items-center justify-center sidebar-open-btn" onClick={()=>dispatch(openSidebar())}>
