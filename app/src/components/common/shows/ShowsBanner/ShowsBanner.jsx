...
import { ShowsBannerWrapper } from "./ShowsBanner.style";
import PropTypes from 'prop-types';
import { FiExternalLink } from "react-icons/fi";
import {MdLanguage} from 'react-icons/md';
// import  {FixExternalLink} from 'react-icons/fi';
const ShowsBanner = ({showData}) => {
  return (
    <ShowsBannerWrapper className="top-spacing-fix">
      ...
      <BaseLinkPrimary to={showData?.officialSite} target="_blank" rel="noopener noreferrer">
