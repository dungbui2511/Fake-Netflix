...
import { SubscriptionItemWrapper, SubscriptionWrapper } from "./Subscription.style"
import PropTypes from 'prop-types';
const Subscription = () => {
  return (
    <SubscriptionWrapper>
      <SectionTitle title={"Choose the plan that's right for you"} text={"Join StreamVibe and select from our flexible description options tailored to suit your viewing preferences.Get ready for non-stop entertainment!"} rightContentType={"title-tabs-button"}/>
      <Container>
